...
--
-- Chart history is deliberately NOT stored: a `candles` table is ~500k rows for
-- data the UI reads one symbol at a time, so the app fetches those bars live
-- from Yahoo instead. See 0004_drop_candles.sql, which removes it from databases
